...
describe('CEREMONY_MS', () => {
  it('is the epoch value of 2027-02-06T14:00:00+08:00', () => {
    ...
    expect(CEREMONY_MS).toBe(1801893600000)
  })

  it('is 2027-02-06T06:00:00Z, the same instant expressed in UTC', () => {
...
describe('breakdown — mixed units against the Ceremony_Datetime', () => {
  // These count toward the real Ceremony_Datetime, 2027-02-06 14:00 +08:00, and
  ...
  it.each([
    ...
    // Jan 25 → Feb 6 is 6 days to the end of January plus 6 into February,
    // 12 days; 06:30:15 → 14:00:00 is 7h 29m 45s.
    {
      label: '2026-12-25 06:30:15 → 1 month, 12 days, 7:29:45',
      now: '2026-12-25T06:30:15',
      expected: { months: 1, days: 12, hours: 7, minutes: 29, seconds: 45 },
    },
    // Exactly six calendar months earlier, same civil time of day, so the
    // remainder is empty. Aug 6 → Feb 6 spans months of 31, 30, 31, 30, 31
    // and 31 days, which plain division could never render as a whole 6.
    {
      label: '2026-08-06 14:00:00 → 6 months exactly',
    ...
    // the span becomes days: Jan 6 15:30 → Feb 6 15:30 is 31 days, and the
    // target is 1h 30m before that, leaving 30 days 22h 30m.
    {
      label: '2027-01-06 15:30:00 → 0 months, 30 days, 22:30:00',
      now: '2027-01-06T15:30:00',
